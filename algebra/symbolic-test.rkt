...
(define-symbolic-algebra sym-algebra)

(define-geo-algebra sym-conformal-algebra sC: [p 4] [q 1] [r 0] [base-field sym-algebra])
(define-geo-algebra conformal-algebra C: [p 4] [q 1] [r 0])

(define-dual-algebra dual-algebra D: [n-dual 3] [base sym-algebra])

(define-geo-algebra diff-conf-algebra dC: [p 4] [q 1] [r 3] [base-field dual-algebra])

(define (d: x) (dC: ((D: x d 1) 1 2) ((D: x d 2) 0 1)))


(define test-1 (geo (C: (1.0 1) (1.0 2)) (C: (1.0 1) (1.0 3))))
(define test-2 (geo (sC: (1.0 1) (1.0 2)) (sC: (1.0 1) (1.0 3))))
(define test-3 (geo (d: 'x) (mul (d: 'y) (d: 'z))))

(require "symbolic-simplifier.rkt")

(map (λ (e) (map simplify-poly ((el-ref e) '() '(0) '(1) '(2)))) ((el-ref test-3) '(1 2)))
